...
public class Ship extends Controllable {
    ...
    public void takeDamage(int damage) {
        health -= damage; // Changed from HEALTH to health
        if (health < 0) { // Changed from HEALTH to health
            health = 0; // Changed from HEALTH to health - Prevent health from dropping below 0
        }
    }
